...
```s
# Run in the Terminal
git clone https://github.com/sitheng/ folder
...
This demo project is solely done by me, Jayanta Samaddar. You can contact me on **[GitHub](https://www.github.com/sitheng)** for interesting projects to work on.
